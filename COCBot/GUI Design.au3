...
;Search2 Tab
$pageSearchSetting2 = GUICtrlCreateTabItem("Search2")
$weakbaseConditions = GUICtrlCreateGroup("weak base setting", 15, 40, 390, 135)
$chkinferno = GUICtrlCreateCheckbox("Avoid Inferno:" , 20, 60, 120, 17)
$chkxbowlvl = GUICtrlCreateCheckbox("Max X-Bow Level:", 20, 85 , 110, 17)
$xbowlvl = GUICtrlCreateCombo("", 130, 85, 60, 21, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
...
$GreedyMode = GUICtrlCreateGroup("Greedy Mode", 15, 180, 390, 130)
$Greedylbl = GUICtrlCreateLabel( "Attack if any of these conditions match:-" ,20,200,380,20)
$chkGreedyMeetGE = GUICtrlCreateCheckbox("Min Resources: ", 30, 223, 100, 17)
GUICtrlSetState(-1, $GUI_UNCHECKED)
$lblGreedyMinGold = GUICtrlCreateLabel("Gold:", 140, 225, 28, 17)
$txtGreedyMinGold = GUICtrlCreateInput("300000", 170, 220, 50, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 6)
$cmbGreedyAny = GUICtrlCreateCombo("", 240, 220, 45, 21, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
GUICtrlSetData(-1, "And|Or", "And")
$lblGreedyMinElixir = GUICtrlCreateLabel("Elixir:", 300, 225, 28, 17)
$txtGreedyMinElixir = GUICtrlCreateInput("300000", 330, 220, 50, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 6)
$chkGreedyMeetDE = GUICtrlCreateCheckbox("Min Dark Elixir:", 30, 253, 95, 17)
$txtGreedyMinDarkElixir = GUICtrlCreateInput("0", 130, 250, 60, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 6)
$chkGreedyMeetTrophy = GUICtrlCreateCheckbox("Min Trophies:", 225, 253, 95, 17)
$txtGreedyMinTrophy = GUICtrlCreateInput("0", 325, 250, 60, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 2)
$chkGreedyMeetTH = GUICtrlCreateCheckbox("Max TH Level:", 30, 283, 95, 17)
$cmbGreedyTH = GUICtrlCreateCombo("", 130, 280, 60, 21, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
GUICtrlSetData(-1, "4-6|7|8|9|10", "4-6")
$chkGreedySnipe = GUICtrlCreateCheckbox("Snipe", 225, 283, 70, 17)

GUICtrlSetState($chkGreedyMeetGE, $GUI_DISABLE)
GUICtrlSetState($txtGreedyMinGold, $GUI_DISABLE)
GUICtrlSetState($cmbGreedyAny, $GUI_DISABLE)
GUICtrlSetState($txtGreedyMinElixir, $GUI_DISABLE)
GUICtrlSetState($chkGreedyMeetDE, $GUI_DISABLE)
GUICtrlSetState($txtGreedyMinDarkElixir, $GUI_DISABLE)
GUICtrlSetState($chkGreedyMeetTrophy, $GUI_DISABLE)
GUICtrlSetState($txtGreedyMinTrophy, $GUI_DISABLE)
GUICtrlSetState($chkGreedyMeetTH, $GUI_DISABLE)
GUICtrlSetState($cmbGreedyTH, $GUI_DISABLE)
GUICtrlSetState($chkGreedySnipe, $GUI_DISABLE)
