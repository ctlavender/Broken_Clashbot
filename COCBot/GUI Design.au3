...
$bypassConditions = GUICtrlCreateGroup("ByPass Conditions", 15, 180, 390, 130)
$bypasslbl = GUICtrlCreateLabel( "Attack if any of these conditions match:-" ,20,200,380,20)
$chkbyMeetGE = GUICtrlCreateCheckbox("Min Resources: ", 30, 223, 100, 17)
GUICtrlSetState(-1, $GUI_UNCHECKED)
$lblbyMinGold = GUICtrlCreateLabel("Gold:", 140, 225, 28, 17)
$txtbyMinGold = GUICtrlCreateInput("300000", 170, 220, 50, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 6)
$cmbbyAny = GUICtrlCreateCombo("", 240, 220, 45, 21, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
GUICtrlSetData(-1, "And|Or", "And")
$lblbyMinElixir = GUICtrlCreateLabel("Elixir:", 300, 225, 28, 17)
$txtbyMinElixir = GUICtrlCreateInput("300000", 330, 220, 50, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 6)
$chkbyMeetDE = GUICtrlCreateCheckbox("Min Dark Elixir:", 30, 253, 95, 17)
$txtbyMinDarkElixir = GUICtrlCreateInput("0", 130, 250, 60, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 6)
$chkbyMeetTrophy = GUICtrlCreateCheckbox("Min Trophies:", 225, 253, 95, 17)
$txtbyMinTrophy = GUICtrlCreateInput("0", 325, 250, 60, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 2)
$chkbyMeetTH = GUICtrlCreateCheckbox("Max TH Level:", 30, 283, 95, 17)
$cmbbyTH = GUICtrlCreateCombo("", 130, 280, 60, 21, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
GUICtrlSetData(-1, "4-6|7|8|9|10", "4-6")
$chkbySnipe = GUICtrlCreateCheckbox("Snipe", 225, 283, 70, 17)
